export class SolutionController {
  ...
  create = async (req, res, next) => {
    try {
      ...
      const solutionData = {
        ...
        ctaButtonTextEn: req.body.ctaButtonTextEn || null,
        ctaButtonTextAr: req.body.ctaButtonTextAr || null,
        ctaButtonLink: req.body.ctaButtonLink || null,
  ...
  update = async (req, res, next) => {
    try {
      ...
      if (req.body.ctaButtonTextEn !== undefined) updateData.ctaButtonTextEn = req.body.ctaButtonTextEn || null;
      if (req.body.ctaButtonTextAr !== undefined) updateData.ctaButtonTextAr = req.body.ctaButtonTextAr || null;
      if (req.body.ctaButtonLink !== undefined) updateData.ctaButtonLink = req.body.ctaButtonLink || null;
