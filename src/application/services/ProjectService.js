export class ProjectService {
  ...
  async addProjectGalleryImage(projectId, imageData) {
    ...
    return await this.projectRepository.addProjectGalleryImage(projectId, imageData);
  }

  async updateProjectGalleryImage(imageId, data) {
    return await this.projectRepository.updateProjectGalleryImage(imageId, data);
  }

  async deleteProjectGalleryImage(imageId) {
    return await this.projectRepository.deleteProjectGalleryImage(imageId);
  }
}
