...
export class ProjectRepository extends IProjectRepository {
  ...
  async updateSectionSettings(id, data) {
    ...
    if (data.galleryTitleEn !== undefined) updateData.galleryTitleEn = data.galleryTitleEn;
    if (data.galleryTitleAr !== undefined) updateData.galleryTitleAr = data.galleryTitleAr;
  ...
  async addProjectGalleryImage(projectId, imageData) {
  ...
  async updateProjectGalleryImage(imageId, data) {
  ...
  async deleteProjectGalleryImage(imageId) {
    return await prisma.projectImage.delete({
      where: { id: imageId },
    });
  }

  async deleteAllProjectGalleryImages(projectId) {
    return await prisma.projectImage.deleteMany({
      where: { projectId },
    });
  }
}
